...
const handleSaveAddress = async () => {
    try {
      ...
      const formattedData: AddressType = {
        ...
        addressId: autoGeneratedId, // Backend usually generates this
      };

      const response = await aaddNewAddressHere(formattedData);
      if (response && response.status === 1) {
        await getAddresses(); // Refresh list
        // Optional: clear form
        setNewAddress({ firstName: "", lastName: "", phone: "", email: "", address1: "", address2: "", zip: "", country: "India", state: "", city: "" });
      } else {
